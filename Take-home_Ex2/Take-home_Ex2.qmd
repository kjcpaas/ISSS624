...
```{r}
#| label: setup
pacman::p_load(sf, sp, tmap, tidyverse, knitr, stplanr, reshape2, performance, ggpubr)
tmap_mode("plot")
tmap_style("natural")
set.seed(1234)
```
